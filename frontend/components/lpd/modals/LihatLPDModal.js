...
export default function LihatLPDModal({ show, onClose, kegiatanId, kegiatanNama, session }) {
    ...
    const getStatusBadge = (status) => {
        if (status === 'selesai') {
            ...
            return <span className="px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800">⏳ Menunggu Kabalai</span>;
        } else if (status === 'menunggu_katim') {
            return <span className="px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800">⏳ Menunggu Katim</span>;
        } else if (status === 'ditolak_katim') {
            return <span className="px-2 py-1 text-xs rounded-full bg-red-100 text-red-800">✗ Ditolak Katim</span>;
        } else if (status === 'ditolak_kabalai') {
            return <span className="px-2 py-1 text-xs rounded-full bg-red-100 text-red-800">✗ Ditolak Kabalai</span>;
                ...
                <div className="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
                    <div className="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                        ...
                        {loading ? (
                            ...
                            <>
                                {/* Status Banner */}
                                <div className="mb-4 p-3 rounded-md" style={{ backgroundColor: lpdData.lpd_status === 'selesai' ? '#f0fdf4' : '#eff6ff' }}>
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            <span className="font-medium text-gray-700">Status LPD:</span>
                                ...
                                <div className="max-h-[60vh] overflow-y-auto">
                                    ...
                                    {activeTab === 'rincian' && (
                                        <div>
                                            <h4 className="text-md font-medium text-gray-900 mb-3">Informasi Kegiatan</h4>
                                            ...
                                            <h4 className="text-md font-medium text-gray-900 mb-3 mt-4">Rincian Hasil Kegiatan</h4>
                                            {lpdData.rincian_kegiatan && lpdData.rincian_kegiatan.length > 0 ? (
                                                ...
                                                <div className="text-center py-4 text-gray-500">Belum ada rincian kegiatan</div>
                                            )}
                                        </div>
                                    )}
                                    ...
                                    {activeTab === 'dokumentasi' && (
                                        <div>
                                            <h4 className="text-md font-medium text-gray-900 mb-3">Dokumentasi Kegiatan</h4>
                                            {lpdData.dokumentasi && lpdData.dokumentasi.length > 0 ? (
                                                ...
                                                <div className="text-center py-4 text-gray-500">Belum ada dokumentasi</div>
                                            )}
                                        </div>
                                    )}
                                    ...
                                    {activeTab === 'pegawai' && (
                                        <div>
                                            <h4 className="text-md font-medium text-gray-900 mb-3">Petugas Pelaksana</h4>
                                            {lpdData.petugas_pelaksana && lpdData.petugas_pelaksana.length > 0 ? (
                                                ...
                                                <div className="text-center py-4 text-gray-500">Belum ada data petugas pelaksana</div>
                                            )}
                                        </div>
                                    )}
                                </div>
