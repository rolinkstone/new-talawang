    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <input
          ...
          className="w-full md:w-96 px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        />
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead className="bg-gray-50 dark:bg-gray-700">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Pangkat</th>
              <th 
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {paginatedData.map((item, idx) => {
                  ...
                  return (
              <tr key={item.pegawai_id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{rowNumber}</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="font-medium text-gray-900 dark:text-gray-100">{item.pegawai_nama}</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">{item.pegawai_jabatan || '-'}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{item.pegawai_nip || '-'}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{item.pegawai_pangkat || '-'}</td>
      ...
      {/* Pagination Controls */}
      {totalPages > 1 && (
        <div className="flex items-center justify-center px-6 py-3 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
