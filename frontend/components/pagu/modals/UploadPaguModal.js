      ...
      <div className="flex items-center justify-center min-h-screen px-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Upload Excel Pagu</h3>
          ...
          <div className="space-y-4">
            ...
            {/* File Input */}
            <div
              className="border-2 border-dashed border-gray-300 rounded-md p-6 text-center cursor-pointer hover:border-indigo-400 transition"
            ...
            >
              ...
              {file ? (
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-600">Klik untuk pilih file Excel</p>
                  <p className="text-xs text-gray-400">.xlsx atau .xls, maks 5MB</p>
                </div>
              )}
            </div>
            ...
            {result && (
              <div className="p-3 bg-green-50 border border-green-200 rounded-md">
                <p className="text-sm text-green-700 font-medium">Import Berhasil</p>
